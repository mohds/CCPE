...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CCPE"."APPLICATIONS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 210 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CCPE"."LOGS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1647 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CCPE"."MESSAGES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 138 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CCPE"."MY_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 943 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (640,88,201);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (641,88,211);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (642,88,299);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (643,88,336);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (644,88,347);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (925,1,446);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (645,88,446);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (926,1,634);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (639,88,193);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (646,88,547);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (647,88,559);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (648,88,603);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (649,88,634);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (923,1,193);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (879,2,347);
Insert into CCPE.ACCESS_GROUPS_METHODS (ID,ACCESS_GROUP_ID_FK,METHOD_ID_FK) values (924,1,336);
...
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (64,'PHYS101',15,'400 USD','Physics 1','Electricity and Magnetism','12-15-2016',40,'12/25/2016',17,50162,'Deleted');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (65,'MCHE101',10,'300 USD','Statics','Basic mechanics for engineering','12-13-2016',50,'12/28/2016',32,10324,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (66,'INME421',10,'300 USD','Engineering Economy','Basic economy','12-20-2016',40,'12/25/2016',20,90143,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (68,'COMP411',10,'450 USD','Java','Basic mechanics for engineering','12-05-2016',40,'11/01/2016',32,103202,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (70,'COMP411',10,'450 USD','Java','Basic mechanics for engineering','12-11-2016',40,'12/06/2016',32,103202,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (71,'COMP411',10,'450 USD','Java','Basic mechanics for engineering','12-13-2016',40,'11/30/2016',32,103202,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (72,'COMP411',10,'450 USD','Java','Basic mechanics for engineering','12-06-2016',408,'12/10/2016',32,103202,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (42,'COMP4111',10,'4504 USD','Java','Basic mechanics for engineering','12-07-2016',408,'12/03/2016',32,10320,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (44,'COMP411',10,'4504 USD','Java5','Electricity and Magnetism','12-06-2016',40,'12/03/2016',32,10320,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (43,'COMP411',10,'450 USD','Java','Basic mechanics for engineering','12-06-2016',40,'12/08/2016',32,103202,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (76,'COMP411',15,'450 USD','Java','Basic mechanics for engineering','12-07-2016',40,'12/09/2016',32,10320,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (77,'COMP411',10,'450 USD','Java5','Basic mechanics for engineering','12-14-2016',40,'11/07/20179',32,103202,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (78,'COMP411',10,'4504 USD','Java','Basic mechanics for engineering','11-06-20167',408,'12/08/2016',32,103202,'Pending');
Insert into CCPE.COURSES (ID,NAME,NUMBER_OF_LECTURES,FEES,TITLE,DESCRIPTION,START_DATE,MAX_CAPACITY,REGISTRATION_DEADLINE,INSTRUCTOR_ID_FK,CRN,STATUS) values (83,'COMP411',103,'4504 USD','Java','Electricity and Magnetism','12-06-2016',40,'12/23/2016',20,10320,'Pending');
...
Insert into CCPE.MESSAGES (ID,SUBJECT,SENDER_ID_FK,RECEIVER_ID_FK,MESSAGE,STATUS,MAILBOX_ID_FK) values (126,'HELLO',402,402,'whaterver','unread',400);
Insert into CCPE.MESSAGES (ID,SUBJECT,SENDER_ID_FK,RECEIVER_ID_FK,MESSAGE,STATUS,MAILBOX_ID_FK) values (127,'HELLO',402,153,'whaterver','unread',151);
